                            ...
                            <div class="btn-group">
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu animation-dock pull-right menu-card-styling" role="menu" style="text-align: left;">
                                        <li><a href="javascript:void(0);" data-toggle="modal" data-target="#addMediumModel"><i class="fa fa-plus"></i> Add Medium</a></li>
                                    </ul>
                                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <label for="Name1">Medium Name</label>
                            </div>
                        </div>
                        <!--end .card-body -->
...
<div class="modal" tabindex="-1" role="dialog" id="updateMediumModel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Add Medium</h5>
