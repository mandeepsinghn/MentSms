...
<section>
    <div class="section-body contain-lg">
        ...
        <div class="row">
            <div class="col-lg-10">
                <h1 class="text-primary">Standards</h1>
            </div>
        </div>
        <!--end .row -->
        <!-- END INTRO -->
                    ...
                    <div class="card-head">
                        ...
                        <div class="tools">
                            <div class="btn-group">
                                ...
                                <a href="javascript:;" data-toggle="modal" class="btn ink-reaction btn-raised btn-primary" data-target="#addStreamModel"><i class="fa fa-plus"></i> Add Standard</a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($item->status!='DELETED')
                                                ...
                                                <a class="btn ink-reaction btn-floating-action btn-danger delete" data-toggle="tooltip" data-placement="top" title="Delete" href="{{ url('standards/destroy/' . $item->id) }}">
...
<div class="modal" tabindex="-1" role="dialog" id="addStreamModel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form class="form form-validate floating-label" method="POST" novalidate="novalidate" action="{{ url('/standards/store', []) }}">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <label for="Name1">Standard Name</label>
                    </div>
                    <div class="form-group">
