...
<section>
    <div class="section-body contain-lg">
        ...
        <div class="row">
            <div class="col-lg-10">
                <h1 class="text-primary">Education Streams</h1>
            </div>
        </div>
        <!--end .row -->
        <!-- END INTRO -->
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="card card-underline">
                    <div class="card-head">
                        <header>All Education Streams</header>
                        <div class="tools">
                            <div class="btn-group">
                                <!-- <div class="btn-group">
                                ...
                                <a href="javascript:;" data-toggle="modal" class="btn ink-reaction btn-raised btn-primary" data-target="#addStreamModel"><i class="fa fa-plus"></i> Add Stream</a>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table no-margin">
                                ...
                                <tbody>
                                    @foreach ($educationStream as $item)
                                    <tr>
                                        <td>{{$item->id}}</td>
                                        <td>{{$item->name}}</td>
                                        <td>{{$item->status}}</td>
                                        <td>
                                            @if($item->status!='DELETED')
                                                ...
                                                <a class="btn ink-reaction btn-floating-action btn-danger delete" data-toggle="tooltip" data-placement="top" title="Delete" href="{{ url('education-streams/destroy/' . $item->id) }}">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Add Education Stream</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <form class="form form-validate floating-label" method="POST" novalidate="novalidate" action="{{ url('/education-streams/store', []) }}">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <label for="Name1">Education Stream Name</label>
                    </div>
                    <div class="form-group">
